...
Repurpose your old phones into a professional-grade security network with this Common Lisp-powered video surveillance application. Designed for users who want to use this project to transform a collection of old phones into functional surveillance cameras, the system leverages high-performance metaprogramming to generate a complete client-side stack at server startup.
